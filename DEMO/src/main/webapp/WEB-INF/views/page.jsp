...
<style>
	...
	.page_next {background: url("image/next.gif") center no-repeat;}
	.page_last {background: url("image/next_.gif") center no-repeat;}
	.page_first {background: url("image/prev.gif") center no-repeat;}
	.page_prev {background: url("image/pre.gif") center no-repeat;}
